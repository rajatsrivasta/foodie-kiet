<?php  
 ...
 <html>  
    ...
    transition-duration: 0.4s;}
      ...
      <body>  
           <br />  
           <div class="container" style="width:800px;margin-top:40px;margin-left:550px">  
                <?php  
                ...
                {  
                     ...
                     INNER JOIN users  
                     ON users.customer_id = tbl_order.customer_id  
                     ...
                     echo '  
                     <h3 align="center" class="head">Order Summary </h3>
                     <p id="ord"><b>Order No.'.$_SESSION["order_id"].' </b></p>
                ...
                ?>  
                <a href ="thanks.php"<button type="button" class="button">Next</button></a>
           </div>  
      </body>  
 </html> 
